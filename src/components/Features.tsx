...
const features = [
  ...
  {
    icon: Box,
    title: "3D INTERACTIVE IDENTITY",
    description: "Real-time .glb object rotation. Your logo becomes an experience.",
    accent: false,
    large: false,
  },
  {
    icon: Smartphone,
    title: "MOBILE COMPACT UI",
    description: "Optimized specifically for handheld devices. Every pixel is intentional.",
    accent: true,
    large: true,
  },
];
