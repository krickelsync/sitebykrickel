...
const pricingData: PricingFeature[] = [{
  ...
  standard: "Base Materia Theme",
  ultimate: "Materia + Krickel Mods"
}, {
  feature: "Page Setup",
  standard: "5 Pages",
  ultimate: "Unlimited Pages"
}, {
  ...
  category: "KRICKEL EXCLUSIVES",
  feature: "Cinematic Enter Page",
  standard: false,
  ultimate: "YES (Video/Img/3D)"
}, {
  feature: "3D Interactive Logo (.glb)",
  standard: false,
  ultimate: "YES (Auto Rotate)"
}, {
  ...
  standard: false,
  ultimate: "YES (Blur Effect)"
}, {
  feature: "Snow/Season Effect",
  standard: false,
  ultimate: "YES (Catalog Page)"
}, {
  category: "VISUAL & AESTHETICS",
  feature: "Background Type",
  standard: "Solid/Image",
  ultimate: "Video BG / Gradient"
}, {
  ...
  standard: false,
  ultimate: "Integrated Timer"
}, {
  category: "SUPPORT",
  feature: "Revisions",
  standard: "1x Minor",
  ultimate: "3x Major Revisions"
}, {
...
const renderValue = (value: string | boolean, isPremium: boolean = false) => {
  ...
  return <span className={`font-mono text-xs md:text-sm ${isPremium ? "text-foreground" : "text-muted-foreground"}`}>
      {value}
    </span>;
};
const rowVariants = {
...
const Pricing = () => {
  return <section id="pricing" className="py-24 md:py-32">
      <div className="container px-4">
          ...
          <div className="min-w-[700px]">
            ...
            <div className="grid grid-cols-[1fr,140px,160px] md:grid-cols-[1fr,180px,200px] gap-2 mb-4">
              ...
              once: true
                ...
                <span className="font-display text-2xl md:text-3xl font-bold">$99</span>
              </motion.div>
              ...
              delay: 0.1
                ...
                <span className="uppercase tracking-tight block mb-1 text-xs font-mono">Ultimate Hype</span>
            ...
            <div className="space-y-1">
              {pricingData.map((row, index) => <motion.div key={index} custom={index} variants={rowVariants} initial="hidden" whileInView="visible" viewport={{
              once: true
            }}>
                  {row.category && <div className="pt-6 pb-2 first:pt-0">
                  ...
                  <div className="grid grid-cols-[1fr,140px,160px] md:grid-cols-[1fr,180px,200px] gap-2 group">
                    ...
                    <div className="p-3 md:p-4 premium-card rounded-xl group-hover:border-primary/30 transition-colors flex items-center justify-center">
                      <div className="flex items-center gap-1.5">
                        {row.ultimate !== false && row.ultimate !== true && typeof row.ultimate === 'string' && <Sparkles size={12} className="text-primary shrink-0" />}
        ...
        once: true
          ...
          <a href="#" className="group relative inline-flex items-center gap-3 bg-primary text-primary-foreground px-10 py-5 font-mono text-sm font-bold uppercase tracking-wider overflow-hidden transition-all duration-300 hover:glow-box">
