...
const Footer = ({ customQuickLinks }: FooterProps = {}) => {
  ...
  return <footer className="relative overflow-hidden border-t border-muted pt-16 md:pt-24">
      ...
      <div className="container px-4 relative">
        <div className="grid md:grid-cols-3 gap-8 md:gap-8 mb-12">
          {/* Brand Column */}
          <motion.div initial={{
          opacity: 0,
          y: 20
          ...
          duration: 0.6,
          delay: 0.1
        }} className="md:space-y-4 border-y border-muted/50 md:border-0 py-3 md:py-0">
            <button
              type="button"
              onClick={() => toggle("links")}
              aria-expanded={openSection === "links"}
              aria-controls="footer-links-panel"
              className="flex w-full items-center justify-between md:pointer-events-none md:cursor-default min-h-[44px] md:min-h-0"
            >
            ...
            <motion.ul
              ...
              className="space-y-3 overflow-hidden md:!h-auto md:!opacity-100 md:mt-0 mt-3"
            >
          ...
          duration: 0.6,
          delay: 0.2
        }} className="md:space-y-4 border-b border-muted/50 md:border-0 pb-3 md:pb-0">
            <button
              type="button"
      ...
      {/* Giant half-cut KRICKEL wordmark — scroll-reactive */}
      <div
        ref={wordmarkRef}
        aria-hidden
        className="relative mt-8 md:mt-12 overflow-hidden select-none"
      >
        <motion.div
          style={
