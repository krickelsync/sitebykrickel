...
const Hero = () => {
  ...
  const mobileHeroLift = isMobile ? -116 : 0;
  const headlineY = useTransform(
    scrollYProgress,
    [0, 1],
    reduce ? [mobileHeroLift, mobileHeroLift] : [mobileHeroLift, isMobile ? -180 : -120]
  );
  ...
  return <section ref={sectionRef} aria-labelledby="hero-heading" className="relative min-h-[100svh] flex items-center justify-center overflow-hidden pt-0 pb-16 md:pt-14 md:pb-24">
      ...
      >
        ...
        <div className="max-w-[min(92vw,74rem)] mx-auto -mt-10 text-center sm:-mt-10 md:mt-0">
          {/* Eyebrow */}
