  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container relative z-10 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          duration: 0.6,
          delay: 0.5
        }} className="font-mono text-sm md:text-base text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">Shopify Setup Service with Premium Theme.We build your high-end store in 48 hours.<br className="hidden sm:block" />
