...
const features = [
  "Flat lay product visuals",
  "Ghost mannequin presentation",
  "Hanging product style",
  "Clean catalog-ready background",
  "Campaign-style product presentation",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Turn raw product photos or mockups into clean, catalog and
                  campaign visuals. No traditional photoshoots required.
                </p>
