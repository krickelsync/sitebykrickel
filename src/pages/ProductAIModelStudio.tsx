...
import { ArrowDown, ChevronRight, Zap, Camera, Clock, Sparkles, Users } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                Skip expensive model agencies. AI Model Studio generates fashion
                models wearing your products—perfect for lookbooks, campaigns, and
                e-commerce listings at a fraction of the cost.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              <div className="container mx-auto px-4 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <span className="font-bold text-sm md:text-base">AI Model Studio</span>
